...
const Login = ({toggleModal,status}:modal) => {
   ...
   return (
    <div>
            <Modal theme={{
            ...
            }} onClick={toggleModal} className="bg-black/50 rounded-none" position={'center'} show={status} size="md" popup={true}>
                ...
                <ModalBody className="bg-white h-96 p-0 rounded-none" onClick={(event)=> {event.stopPropagation()}} >
                    ...
                    <div className="p-6 pt-0">
                        ...
                        <div onClick={handleClick} className="flex items-center justify-center rounded-md border-2 border-solid border-gray-300 p-5 relative h-8 cursor-pointer active:bg-teal-100"    >
